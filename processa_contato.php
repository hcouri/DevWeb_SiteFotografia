...
$stmt = $conn->prepare("INSERT INTO contato (nome, email, telefone, data, horario, mensagem) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssss", $nome, $email, $telefone, $data, $horario, $mensagem);
    ...
    if ($stmt->execute()) {
        ...
        //  Buscar orçamentos existentes pelo email ou telefone
        ...
        if ($result->num_rows > 0) {
            //  Inserir em contratacoes para cada orçamento encontrado
